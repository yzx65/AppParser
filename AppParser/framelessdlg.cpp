...
void FramelessDlg::InitTitleBar()
{
	...
	m_closeBtn->setFixedSize(30, 27);
	minBtn->setFixedSize(30, 27);
	menuBtn->setFixedSize(30, 27);
	maxBtn->setFixedSize(30, 27);
	...
	connect(maxBtn, SIGNAL(clicked()), this, SLOT(OnBtnMaxClicked()));
...
void FramelessDlg::OnBtnMaxClicked()
{
	if ( m_maximized )
	{
